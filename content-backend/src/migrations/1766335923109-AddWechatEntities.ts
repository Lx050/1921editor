...
export class AddWechatEntities1766335923109 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_74a1821304e1f9e62be5bc9bff" ON "wechat_authorizers" ("tenantId", "authorizerAppId") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "articles" ADD CONSTRAINT "FK_ee1c1577f1e3cfc6629cec86f57" FOREIGN KEY ("tenantId") REFERENCES "tenants"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "wechat_authorizers" ADD CONSTRAINT "FK_f12f88d87e969f03990b152ab62" FOREIGN KEY ("tenantId") REFERENCES "tenants"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "wechat_authorizers" DROP CONSTRAINT "FK_f12f88d87e969f03990b152ab62"`,
    );
    await queryRunner.query(
      `ALTER TABLE "articles" DROP CONSTRAINT "FK_ee1c1577f1e3cfc6629cec86f57"`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" DROP CONSTRAINT "FK_c58f7e88c286e5e3478960a998b"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_ee1c1577f1e3cfc6629cec86f5"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_a80f2b71c4ce62405b1686a13b"`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ALTER COLUMN "isactive" DROP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ADD CONSTRAINT "UQ_f1b4e50d435570b5abdf6341f05" UNIQUE ("feishuId")`,
    );
    await queryRunner.query(
      `ALTER TABLE "tenants" ADD "updatedat" TIMESTAMP DEFAULT now()`,
    );
    await queryRunner.query(
      `ALTER TABLE "tenants" ADD "createdat" TIMESTAMP DEFAULT now()`,
    );
    await queryRunner.query(
      `ALTER TABLE "tenants" ADD "isactive" boolean DEFAULT true`,
    );
    await queryRunner.query(`DROP TABLE "wechat_platform_config"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_74a1821304e1f9e62be5bc9bff"`,
    );
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_users_tenant_feishu" ON "users" ("feishuId", "tenantId") `,
    );
    await queryRunner.query(
      `ALTER TABLE "articles" ADD CONSTRAINT "FK_articles_tenant" FOREIGN KEY ("tenantId") REFERENCES "tenants"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ADD CONSTRAINT "FK_users_tenant" FOREIGN KEY ("tenantId") REFERENCES "tenants"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }
}
